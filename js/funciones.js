...
let QueHaceTexto = ["Programador full time","Programador y/o Diseñador","Programador Web","Programador Web y/o mobil","Nada"];
var banderaDatos = 0;
...
var txtLugarNa = "Algun lugar generico";
var txtEmail = "generico@ejemplos.com";
var txtTelefono = "+549000000000";
var txtImagen = "imagenes/basica.jpg";

function IrA(donde) {
    let url = "";
    if (donde == "FA") url = "https://facebook.com/";
    if (donde == "TW") url = "https://twitter.com/";
    if (donde == "GH") url = "https://github.com/";
    window.open(url);
}
